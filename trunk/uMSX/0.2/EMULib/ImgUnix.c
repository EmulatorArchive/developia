...
void ClearImage(Image *Img,int Color)
{
    ...
    {
    case 8:
        ClearImage_8(Img,Color);
        break;
    case 16:
        ClearImage_16(Img,Color);
        break;
    case 24:
    case 32:
        ClearImage_32(Img,Color);
        break;
    }
}
...
void IMGCopy(Image *Dst,int DX,int DY,Image *Src,int SX,int SY,int W,int H,int TColor)
{
    ...
    {
    case 8:
        IMGCopy_8(Dst,DX,DY,Src,SX,SY,W,H,TColor);
        break;
    case 16:
        IMGCopy_16(Dst,DX,DY,Src,SX,SY,W,H,TColor);
        break;
    case 24:
    case 32:
        IMGCopy_32(Dst,DX,DY,Src,SX,SY,W,H,TColor);
        break;
    }
}
...
void IMGDrawRect(Image *Img,int X,int Y,int W,int H,int Color)
{
    ...
    {
    case 8:
        IMGDrawRect_8(Img,X,Y,W,H,Color);
        break;
    case 16:
        IMGDrawRect_16(Img,X,Y,W,H,Color);
        break;
    case 24:
    case 32:
        IMGDrawRect_32(Img,X,Y,W,H,Color);
        break;
    }
}
...
void IMGFillRect(Image *Img,int X,int Y,int W,int H,int Color)
{
    ...
    {
    case 8:
        IMGFillRect_8(Img,X,Y,W,H,Color);
        break;
    case 16:
        IMGFillRect_16(Img,X,Y,W,H,Color);
        break;
    case 24:
    case 32:
        IMGFillRect_32(Img,X,Y,W,H,Color);
        break;
    }
}
...
void SoftenImage(Image *Dst,const Image *Src,int X,int Y,int W,int H)
{
    ...
    {
    case 8:
        SoftenImage_8(Dst,Src,X,Y,W,H);
        break;
    case 16:
        SoftenImage_16(Dst,Src,X,Y,W,H);
        break;
    case 24:
    case 32:
        SoftenImage_32(Dst,Src,X,Y,W,H);
        break;
    }
}
...
void ScaleImage(Image *Dst,const Image *Src,int X,int Y,int W,int H)
{
    ...
    {
    case 8:
        ScaleImage_8(Dst,Src,X,Y,W,H);
        break;
    case 16:
        ScaleImage_16(Dst,Src,X,Y,W,H);
        break;
    case 24:
    case 32:
        ScaleImage_32(Dst,Src,X,Y,W,H);
        break;
    }
}
...
void TelevizeImage(Image *Img,int X,int Y,int W,int H)
{
    ...
    {
    case 8:
        TelevizeImage_8(Img,X,Y,W,H);
        break;
    case 16:
        TelevizeImage_16(Img,X,Y,W,H);
        break;
    case 24:
    case 32:
        TelevizeImage_32(Img,X,Y,W,H);
        break;
    }
}
